...
class VideoAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.client.login(email='joowhi@email.com', password='password123')
    ...
    def test_video_list_get(self):
        # url = 'http://127.0.0.1:8000/api/v1/video' -> 직접 입력하면 계속 수정해야 해서 reverse() 함수 사용
    ...
    def test_video_list_post(self):
        ...
        data = {
            ...
            'user':self.user.pk # 방금 로그인한 유저의 아이디값
        }
